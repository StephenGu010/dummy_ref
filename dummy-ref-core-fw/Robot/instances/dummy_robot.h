...
public:
    ...
    void Reboot();
    void SetEnable(bool _enable);
    void SetLedEnable(bool _enable);
    bool GetLedEnabled();
    void SetRGBEnable(bool _enable);
    bool GetRGBEnabled();
    void SetRGBMode(uint32_t mode);
    uint32_t GetRGBMode();
    void SetRGBColor(uint8_t _r, uint8_t _g, uint8_t _b);
    void GetRGBColor(uint8_t &_r, uint8_t &_g, uint8_t &_b);
    void CalibrateHomeOffset();
    void Homing();
    void Resting();
    bool IsMoving();
    bool IsEnabled();
    uint32_t GetCommandMode();
...
private:
    ...
    uint32_t rgbMode = 0;
    uint8_t rgbColor[3] = {100, 100, 100};
};
